...
void gridClean2();
void spiralClean();
void poseCallback2(const nav_msgs::Odometry::ConstPtr & odom_message);
...
int main(int argc, char **argv)
{
    ...
    pos_subscriber = n.subscribe("/odom", 10, poseCallback2);
...
void poseCallback2(const nav_msgs::Odometry::ConstPtr & odom_message){
	/*
    int ind = sizeof(pose_message.pose)-1;
    turtlebot_pose.position.x=pose_message.pose[ind].position->x;
    turtlebot_pose.position.y=pose_message.pose[ind].position->y;
    turtlebot_pose.position.z=pose_message.pose[ind].position->z;
    printf ("floats: %4.4f", turtlebot_pose.position.x);
    printf ("floats: %4.4f", turtlebot_pose.position.y);
    printf ("floats: %4.4f", turtlebot_pose.position.z);
    */
    //printf ("int: %li", sizeof(pose_message->name));
	//turtlebot_pose = odom_message->pose;
...
void gridClean2(){
	...
	/*rotate(degrees2radians(5), degrees2radians(45), true);
	move(0.5, 3, true);
	loop.sleep();
	rotate(degrees2radians(5), degrees2radians(45), false);
	rotate(degrees2radians(5), degrees2radians(88), false);
	loop.sleep();*/
	int c = 0;
	/*
	move(2, 9, true);
	...
	do{
		...
		move(0.5, 3, true);
		loop.sleep();
		rotate(degrees2radians(5), degrees2radians(88), true);
		loop.sleep();
		move(0.5, 0.5, true);
		rotate(degrees2radians(5), degrees2radians(88), true);
		loop.sleep();
	...
	}while(c<4);//while(getDistance(turtlesim_pose.x, turtlesim_pose.y, 1, 1)>1);
