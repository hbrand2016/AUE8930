...
void gridClean2(){
	...
	rotate(degrees2radians(15), degrees2radians(88), false);
	loop.sleep();
	...
	do{
		...
		rotate(degrees2radians(15), degrees2radians(88), true);
		loop.sleep();
		move(2, 1, true);
		rotate(degrees2radians(15), degrees2radians(88), true);
		loop.sleep();
	...
	}while(getDistance(turtlesim_pose.x, turtlesim_pose.y, 1, 1)>1);
